...
describe("Todo Application", function () {
  ...
  //   const trueResponse = await agent.delete("/todos/1");
  //   expect(trueResponse.text).toBe("true");
  //   const falseResponse = await agent.delete("/todos/1");
  //   expect(falseResponse.text).toBe("false");
  // });
});
